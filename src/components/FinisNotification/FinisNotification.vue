...
<template>
  <div
    role="alert"
    class="fixed top-1 right-1 z-9999 alert min-h-12 w-xs alert-vertical bg-base-100 sm:alert-horizontal"
    :class="currentConfig.alertBorder"
  >
    <svg
      ...
      :class="currentConfig.iconStroke"
    >
      <path
